...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: ...
    My name is **Addison Schmidt**, and I am a *computer science* major. I am involved in the chess, Judo, CSE, and ICPC clubs. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: ...
    A job I think is related to data science is being a researcher in a number of computer science fields. I have some experience with this firsthand as an undergraduate research assistant, where data science and statistics were crucial to conducting a computational analysis. (https://www.undergradresearch.iastate.edu/about) !(server.png)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: ...
    I will be most interested in training machine learning models.
